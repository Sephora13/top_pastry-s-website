...
export default function Footer() {
  return (
    <footer className="bg-primary text-white py-16">
      ...
      {/* Top border separator as in mockup */}
      <div className=" pt-8 border-t border-white/10 hidden md:block"></div>
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          
          {/* Logo / First column */}
          <div className="col-span-1">
            <h3 className="font-title font-bold text-xl mb-4 tracking-wide text-cream">Top Pastry</h3>
          ...
          {/* Navigation */}
          <div className="col-span-1">
            <h3 className="font-title font-bold text-base mb-6 tracking-wide text-cream">Navigation</h3>
          ...
          <div className="col-span-1">
            <h3 className="font-title font-bold text-base mb-6 tracking-wide text-cream">Informations</h3>
            <ul className="space-y-4 text-[13px] text-white/80 font-medium">
          ...
          {/* Légal & Réseaux */}
          <div className="col-span-1">
            <h3 className="font-title font-bold text-base mb-6 tracking-wide text-cream">Légal & Réseaux</h3>
