    ...
    <div className="min-h-screen bg-amber-50">
      <div className="container mx-auto p-6">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-title font-bold text-amber-900">
            Gestion des Produits
          </h2>
          <Link
            href="/produits"
            className="bg-amber-600 text-white px-4 py-2 rounded font-title hover:bg-amber-700 transition"
          >
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h3 className="text-xl font-title font-semibold text-amber-800 mb-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end">
              <button
                type="submit"
                className="bg-amber-800 text-white px-6 py-2 rounded font-title hover:bg-amber-900 transition"
              >
